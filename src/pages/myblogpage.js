            ...
            <div class="child second">
                <div className="searcharea">
                    ...
                    <div className='search'>
                        <input type="text" placeholder="‘현영’ 님의 블로그 제목으로 검색해 보세요!" onfocus="if(this.placeholder=='‘현영’ 님의 블로그 제목으로 검색해 보세요!') this.placeholder='';" onblur="if(this.placeholder=='') this.placeholder='‘현영’ 님의 블로그 제목으로 검색해 보세요!';" />
                    </div>
                    <div className='searchImage'>
                        <span>searchImageasd</span>
                    </div>
                </div>
                        ...
                        <div className='PostCardBlock'>
                            ...
                            <div className='PostCardBlockContents'>
                                ...
                                <div className='PostCardBlockContents_Link'>
                                    ...
                                    <div>
                                        <p className='PostCardBlockContents_subtitle'>디버깅 중 마주친 문제는 Stack Overflow 검색을 통해 도움을 얻을 수 있다.</p>
                                    </div>
                                </div>
