                    ...
                    <div className="profile">
                        ...
                        <div className='Introduce'>
                            ...
                            <div className='subIntro'>
                                안녕하세요~ <br />잔디밭 채우고 싶은 <br />프론트 앤드 개발자 입니다.
                            </div>
                        </div>
                            ...
                            <div style={{ marginRight: '10px' }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14"
                                    ...
                                    <path
                                        ...
                                        stroke="#7D7D7D" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </div>
                ...
                <div className="child second">
                    ...
                    <div className="new-contents">
                        ...
                        <div className='PostCard'>
                            <div className='PostCardBlock' onClick={() => {navigate('/postview/' + postArr[0]['id']);}}>
                                ...
                                <div className='PostCardBlockContents'>
                                    ...
                                    <div className='PostCardBlockContents_Link'>
                                        <h4 className='PostCardBlockContents_Title'>{postArr[0]['title']}</h4>
                                        <div>
                                            <p className='PostCardBlockContents_subtitle'>{postArr[0]['contents']}</p>
                                        </div>
                                    </div>
                            ...
                            <div className='PostCardBlock' onClick={() => {navigate('/postview/' + postArr[1]['id']);}}>
                                <div className='PostCardBlockImage'>
                                    <div className='PostCardBlockImage_Link' style={{ paddingTop: '55.1921%' }}>
                                ...
                                <div className='PostCardBlockContents'>
                                    ...
                                    <div className='PostCardBlockContents_Link'>
                                        <h4 className='PostCardBlockContents_Title'>{postArr[1]['title']}</h4>
                                        <div>
                                            <p className='PostCardBlockContents_subtitle'>{postArr[1]['contents']}</p>
                                        </div>
                                    </div>
                                    <div className='PostCardBlockDate'>
                                        <span>2023-10-01</span>
                            ...
                            <div className='PostCardBlock' onClick={() => {navigate('/postview/' + postArr[2]['id']);}}>
                                <div className='PostCardBlockImage'>
                                    <div className='PostCardBlockImage_Link' style={{ paddingTop: '55.1921%' }}>
                                ...
                                <div className='PostCardBlockContents'>
                                    ...
                                    <div className='PostCardBlockContents_Link'>
                                        <h4 className='PostCardBlockContents_Title'>{postArr[2]['title']}</h4>
                                        <div>
                                            <p className='PostCardBlockContents_subtitle'>{postArr[2]['contents']}</p>
                                        </div>
                                    </div>
                                    <div className='PostCardBlockDate'>
                                        <span>2023-10-01</span>
                            ...
                            <div className='PostCardBlock' onClick={() => {navigate('/postview/' + postArr[3]['id']);}}>
                                <div className='PostCardBlockImage'>
                                    <div className='PostCardBlockImage_Link' style={{ paddingTop: '55.1921%' }}>
                                ...
                                <div className='PostCardBlockContents'>
                                    ...
                                    <div className='PostCardBlockContents_Link'>
                                        <h4 className='PostCardBlockContents_Title'>{postArr[3]['title']}</h4>
                                        <div>
                                            <p className='PostCardBlockContents_subtitle'>{postArr[3]['contents']}</p>
                                        </div>
                                    </div>
                                    <div className='PostCardBlockDate'>
                                        <span>2023-10-01</span>
                            ...
                            <div className='PostCardBlock' onClick={() => {navigate('/postview/' + postArr[4]['id']);}}>
                                <div className='PostCardBlockImage'>
                                    <div className='PostCardBlockImage_Link' style={{ paddingTop: '55.1921%' }}>
                                        <img src='image\Rectangle 31.png' />
                                    </div>
                                ...
                                <div className='PostCardBlockContents'>
                                    ...
                                    <div className='PostCardBlockContents_Link'>
                                        <h4 className='PostCardBlockContents_Title'>{postArr[4]['title']}</h4>
                                        <div>
                                            <p className='PostCardBlockContents_subtitle'>{postArr[4]['contents']}</p>
                                        </div>
                                    </div>
                                    <div className='PostCardBlockDate'>
                                        <span>2023-10-01</span>
                            ...
                            <div className='PostCardBlock' onClick={() => {navigate('/postview/' + postArr[5]['id']);}}>
                                <div className='PostCardBlockImage'>
                                    <div className='PostCardBlockImage_Link' style={{ paddingTop: '55.1921%' }}>
                                        <img src='image\Rectangle 31.png' />
                                    </div>
                                ...
                                <div className='PostCardBlockContents'>
                                    ...
                                    <div className='PostCardBlockContents_Link'>
                                        <h4 className='PostCardBlockContents_Title'>{postArr[5]['title']}</h4>
                                        <div>
                                            <p className='PostCardBlockContents_subtitle'>{postArr[5]['contents']}</p>
                                        </div>
                                    </div>
                                    <div className='PostCardBlockDate'>
                                        <span>2023-10-01</span>
                            ...
                            <div className='PostCardBlock' onClick={() => {navigate('/postview/' + postArr[6]['id']);}}>
                                <div className='PostCardBlockImage'>
                                    <div className='PostCardBlockImage_Link' style={{ paddingTop: '55.1921%' }}>
                                        <img src='image\Rectangle 31.png' />
                                    </div>
                                ...
                                <div className='PostCardBlockContents'>
                                    ...
                                    <div className='PostCardBlockContents_Link'>
                                        <h4 className='PostCardBlockContents_Title'>{postArr[6]['title']}</h4>
                                        <div>
                                            <p className='PostCardBlockContents_subtitle'>{postArr[6]['contents']}</p>
                                        </div>
                                    </div>
                                    <div className='PostCardBlockDate'>
                                        <span>2023-10-01</span>
                            ...
                            <div className='PostCardBlock' onClick={() => {navigate('/postview/' + postArr[7]['id']);}}>
                                <div className='PostCardBlockImage'>
                                    <div className='PostCardBlockImage_Link' style={{ paddingTop: '55.1921%' }}>
                                        <img src='image\Rectangle 31.png' />
                                    </div>
                                ...
                                <div className='PostCardBlockContents'>
                                    ...
                                    <div className='PostCardBlockContents_Link'>
                                        <h4 className='PostCardBlockContents_Title'>{postArr[7]['title']}</h4>
                                        <div>
                                            <p className='PostCardBlockContents_subtitle'>{postArr[7]['contents']}</p>
                                        </div>
                                    </div>
                                    <div className='PostCardBlockDate'>
                                        <span>2023-10-01</span>
